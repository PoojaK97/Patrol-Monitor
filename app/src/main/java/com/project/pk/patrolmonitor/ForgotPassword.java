...
public class ForgotPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(com.project.pk.patrolmonitor.ForgotPassword.this,SignUp.class));
                finish();
            }
        });
                    ...
                    mAuth.sendPasswordResetEmail(mEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                startActivity(new Intent(com.project.pk.patrolmonitor.ForgotPassword.this, LoginActivity.class));
                                finish();
                            }
                            else {
